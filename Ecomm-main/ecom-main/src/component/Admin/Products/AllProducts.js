...
const AllProducts = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://swiftmart-416707.el.r.appspot.com/api/products/getallproducts")
      .then((response) => {
  ...
  //     await axios.post(`https://swiftmart-416707.el.r.appspot.com/api/products/update${fieldToUpdate}`, updateData);

  //     // Fetch updated data after successful update
  //     const updatedList = await axios.get('https://swiftmart-416707.el.r.appspot.com/api/products/getallproducts');
  ...
  const handleDeleteProduct = async (productId) => {
    try {
      await axios.post("https://swiftmart-416707.el.r.appspot.com/api/products/deleteproduct", {
        id: productId,
      });
...
//         })
//         // const response = await axios.get('https://swiftmart-416707.el.r.appspot.com/api/products/getallproducts');
//         // setListData(response.data);
//       } catch (error) {
